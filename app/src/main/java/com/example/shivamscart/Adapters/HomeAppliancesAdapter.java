...
public class HomeAppliancesAdapter extends RecyclerView.Adapter<HomeAppliancesAdapter.viewHolder> {
    ArrayList<ProductsModel> list;
    Context context;

    public HomeAppliancesAdapter(ArrayList<ProductsModel> list, Context context) {
        this.list = list;
